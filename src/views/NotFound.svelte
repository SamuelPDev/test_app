...
<div
  class="h-screen w-screen {$darkMode
    ? 'bg-gray-900'
...
>
  ...
  >
    <div class="max-w-md {$darkMode && "text-gray-300"}">
      <div class="text-5xl font-dark font-bold">404</div>
      <p class="text-2xl md:text-3xl font-light leading-normal">
        Ups no hemos encontrado lo que buscas.
      </p>
      <p class="mb-8">
        Pero no te preocupes, puedes tratar de buscar otra vez en nuestra pagina
        de inicio.
      </p>

      <button
        class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-indigo-600 active:bg-indigo-600 hover:bg-indigo-700"
    ...
    <div class="max-w-lg">
      <svg
        ...
        ><title>Artboard 1 copy</title><path
          class="cls-1"
        ...
        /><ellipse
          ...
          rx="153"
          ry="117"
        /><circle class="cls-9" cx="1355" cy="991" r="31.5" /><path
          class="cls-10"
        ...
        /><circle class="cls-12" cx="1355" cy="991" r="22.5" /><circle
          ...
          cy="991"
          r="31.5"
        /><circle class="cls-12" cx="1557" cy="991" r="22.5" /><path
          class="cls-10"
        ...
        /><circle class="cls-9" cx="395.47" cy="335.18" r="65.13" /><path
          class="cls-17"
